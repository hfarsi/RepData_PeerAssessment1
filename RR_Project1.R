RR_Project1 <- function() {
  ...
  png(file = "dailyTotal-1.png", width = 580, height = 480)
  ...
  png(file = "intervalMean-1.png", width = 580, height = 480)
  ...
  png(file = "dailyTotal-3.png", width = 580, height = 480)
  ...
  png(file = "intervalMean-2.png", width = 580, height = 480)
  ...
  png(file = "weekdays-1.png", width = 580, height = 480)
